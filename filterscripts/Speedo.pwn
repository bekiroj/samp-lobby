...
{
	print("\n--------------------------------------");
	print(" Hýz Gösterge Sistemi Indirildi-");
	print("--------------------------------------\n");
...
public OnPlayerCommandText(playerid, cmdtext[])
{
	if (strcmp("/speedo", cmdtext, true, 10) == 0)
	{
	    ...
	    {
	        Gosterge[playerid] = 0;
	        SendClientMessage(playerid,ADMIN_RED,"<< Hýz Göstergesi Kapandý.");
	    }
	    else if(Gosterge[playerid] == 0)
	    {
	        Gosterge[playerid] = 1;
	        SendClientMessage(playerid,LIGHTGREEN,">> Hýz Göstergesi Açýldý.");
	    }
		return 1;
	}
	return 0;
